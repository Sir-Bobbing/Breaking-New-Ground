...
<Recipe id="sawmill:sawmill" />
##### Trading Post
- Allows you to trade with all Villagers within a 24x16x24 block radius
<Recipe id="tradingpost:trading_post" />
##### Dummy
- Hitting it tells you your Damage Per Second.
<Recipe id="dummmmmmy:dummy_crafting" />

*Tip: to remove, <KeyBind id="key.attack"/> + <KeyBind id="key.sneak"/>*
...
##### Particle Emitter
- Can be configured to produce particle of any type with various variables.
- Turns on when powered with redstone.
<Recipe id="particlemimicry:particle_emitter" />
*Tip: Can lag your game if you're not careful!*