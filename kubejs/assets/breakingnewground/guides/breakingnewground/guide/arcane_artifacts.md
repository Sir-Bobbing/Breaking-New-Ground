...
---
## Bags of Holding
If inventory management is becoming a problem. consider looking into the creation of a **Bag of Holding** <ItemImage id="bagofholding:iron_bag_of_holding" scale="0.5"/>. 

These are useful objects with somehow hold more than their size would allow.
There are three variants, all able to hold more than the last

<Row>
 <Recipe id="bagofholding:leather_bag_of_holding" />
 <RecipeFor id="bagofholding:iron_bag_of_holding" />
 <RecipeFor id="bagofholding:golden_bag_of_holding" />
 </Row>